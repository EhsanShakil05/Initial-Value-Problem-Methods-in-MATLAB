...
% y"'=e^(3t)+(3t+3)(e^(3t))+4y'
% y"'=e^(3t)(3t+4)+4te^(3t)−8y
% y"'=e^(3t)(7t+4)-8y

% Problem
f = @(t,y) t*exp(3*t) - 2*y;
fy = @(t,y) (t+1).*exp(3*t) + 4*y;
fyy = @(t,y) (7*t+4).*exp(3*t)-8*y;
...
for i = 1:N
    ...
    y2 = fy(t(i),y(i));
    y3 = fyy(t(i),y(i));
    y(i+1) = y(i) + h*y1 + y2*h^2/2 + y3*h^3/6;
end
...
xlabel('t')
ylabel('y')
title('Taylor Method Order 3 vs Exact Solution')
legend('Exact Solution','Taylor Method Order 3')
grid on